...
<head>
    ...
    <title>PetFinder - Inscreva-se</title>
</head>
<body>
    <!-- Main Container -->
    ...
    <!-- Left box(holds the image and the light) -->
        ...
        <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box " style="background: darkorange;">
            ...
            <div class="featured-image mb-3">
                <img src="images/signup2nobg.png" class="img-fluid" style="width: 390px">
            </div>
        ...
        <div class="col-md-6 right-box">
            <div class="row align-items-center">
                ...
                <div class="header-text mb-4">
                    ...
                    <p>Localizador de pet, produtos, acessórios e muito mais!</p>
                </div>
                ...
                <div class="input-group mb-3">
                    <button class=" btn btn-lg btn-outline-primary w-100 fs-6">Inscrever-se</button>
                </div>
                ...
                <div class="row">
                    <small>Já possui Conta? <a href="../Login/login.php">Login</a></small>
                </div>
            </div>
        </div>
